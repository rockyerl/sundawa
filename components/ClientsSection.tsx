    ...
    return (
        <section id="clients" ref={ref} style={{ position: 'relative' }}>
            <div className="container-main">
                <motion.div initial={{ opacity: 0, x: -20 }} animate={inView ? { opacity: 1, x: 0 } : {}} style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
                ...
                <div className="clients-layout">
                    ...
                    <div className="clients-left">
                        ...
                        <motion.div initial={{ opacity: 0, y: 10 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.3 }}
                                    style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', background: 'rgba(219,201,119,0.12)', border: '1px solid rgba(219,201,119,0.12)', marginBottom: '1.25rem' }}>
                            {stats.map((s) => (
                        ...
                        <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.4 }}
                                    style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', padding: '0.75rem 1rem', border: '1px solid rgba(219,201,119,0.15)', background: 'rgba(219,201,119,0.04)' }}>
