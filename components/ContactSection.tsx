...
const WA_MESSAGE = 'Halo Sundawa Teknologi, saya ingin mengetahui lebih lanjut tentang layanan Anda.'
...
const contacts: { icon: IconComponent; label: string; value: string; href: string; desc: string }[] = [
    ...
    { icon: LinkedInIcon, label: 'LinkedIn', value: 'Sundawa Teknologi Indonesia', href: 'https://www.linkedin.com/company/sundawa-teknologi-indonesia', desc: 'Follow us on LinkedIn' },
]
    ...
    return (
        <>
            ...
            >
                ...
                <span
                    className="hidden md:block text-[11px] font-bold tracking-[0.15em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    style={{
                        color: '#0E1E30',
                        background: '#DBC977',
                        padding: '6px 14px',
                ...
                {/* Button */}
                <div
                    className="relative w-14 h-14 flex items-center justify-center transition-transform duration-300 group-hover:scale-110"
                    style={{
                        background: '#25D366',
