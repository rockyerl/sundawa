        ...
        <>
            <section id="contact" ref={ref} className="relative py-32 overflow-hidden">
                ...
                <div className="container-main relative z-10">
                    ...
                    >
                        <span className="text-xs font-bold tracking-[0.3em] uppercase text-[#DBC977]">— Contact</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                            ...
                            >
                                ...
                                <a
                                    ...
                                    onMouseEnter={e => {
                                        ...
                                        el.style.boxShadow = '0 0 40px rgba(219,201,119,0.35)'
                                    }}
                                    onMouseLeave={e => {
                                        const el = e.currentTarget as HTMLAnchorElement
                                        el.style.background = '#DBC977'
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            >
                                ...
                                <span className="text-[11px] text-[#F8F8F8]/20 tracking-widest uppercase">Bandung, Jawa Barat, Indonesia</span>
                            </motion.div>
                        </div>
                    </div>
